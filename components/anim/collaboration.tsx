...
export const Collaboration = () => {
  ...
  return (
    <section
      ref={targetRef}
      className="bg-white relative z-10 mt-[-30vh] h-[300vh]"
    >
        ...
        <div className="sticky top-[10vh]">
          <div className="flex justify-center">
            <motion.div style={{ scale, x, y }} className="origin-top">
              <motion.img
                style={{ opacity }}
                src="https://www.chanel.com/puls-img/c_limit,w_2400/q_auto:good,dpr_auto,f_auto/1744097455114-chancehpcorpotakeoverwwdesktopjpg_1260x2880.jpg"
