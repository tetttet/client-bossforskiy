...
export const StreamlinedExperience = () => {
  ...
  return (
    ...
    >
      <div className="sticky top-1/2 left-1/2 min-h-[50rem] min-w-[50rem] -translate-x-1/2 -translate-y-1/2 whitespace-nowrap before:absolute before:inset-0 before:scale-[var(--scale)] before:border-[2.5rem] before:border-[#fbea8d] before:opacity-[var(--opacity-border)]">
        <motion.p
          aria-hidden
          style={{ x: textX, y: "-50%" }}
        ...
        <span
          className="absolute left-[calc(50%*var(--scale)+50%-(2.5rem*var(--scale)))] top-0 z-[12] h-full w-[2.5rem] origin-left scale-[var(--scale)] opacity-[var(--opacity-border)]"
          style={{
            background:
              "linear-gradient(to bottom, #f9f295, #e0aa3e, #faf398, #b88a44)",
          }}
        />
      </div>
    </motion.section>
